...
| 5 | **One-card join UX** — publish/copy on A, paste/fetch on B | **done** — [`src/components/MistFarmSyncCard.tsx`](../../plugins/freenet_host/src/MistFarmSyncCard.tsx) above the workshop card in Settings |
