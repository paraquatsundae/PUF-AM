...
| 4 | `BV-04` | **Orchard \(k\)** — H/M/L or bud CFU → Ji \(k\); retire faux `springStartingInoculum` as biology | Primary inoculum is first-order in Ji | `todo` |
...
| 6 | `BV-06` | **Incubation** — Ji 15–21 d delay distribution for symptom onset (not GDD “eruption” sandbox); keep secondary inoculum explicit | Matches Adaskaveg field lag; GDD queue is not Ji | `todo` |
...
| 9 | `BV-09` | **Client ↔ Cloud Function parity** — aggregates must run same Ji module | Dashboard vs Blight Risk drift | `todo` |
...
| 14 | `BV-14` | **Claim discipline** — About/README: “Ji et al. 2025 process model (WA wetness proxy until sensors)” | Stop “Ji-inspired SEI” handwave | `todo` |
