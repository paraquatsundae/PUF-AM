...
**Status:** Active — BE-03 research knobs on Blight → Sandbox; Advanced renamed Economics; BE-04 next (About science move)  
**Date:** 2026-08-11  
...
- [x] Settings → Advanced has **no** blight / sandbox / canopy / chem-bio controls *(BE-03 — tab renamed Economics)*
...
- [x] Farm without walnut pack: Advanced (or Economics) unchanged for market fields; no blight UI anywhere *(BE-03 Economics tab)*
