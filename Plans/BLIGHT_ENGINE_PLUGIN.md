...
**Status:** Draft plan — no runtime code yet  
**Date:** 2026-08-11  
...
|----|-------|--------|-------|
| `BE-00` | **This plan** + cross-links | `in_progress` | Docs only |
| `BE-01` | Extract blight panels + glossary from `Settings.tsx` into `BlightEngineSettings` (behaviour-identical, still mounted under Advanced) | `not_started` | Pure refactor; no UX move yet; safest first PR |
