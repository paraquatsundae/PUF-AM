...
- [ ] Hole 5 closed in §8; E-08 marked done in ROADMAP. **Next (2026-09-15) — two tracks:** codebase health + security review, then issue photos over Freenet (packet size; photos not shipped); **parallel:** chill portions pack + weather/DPIRD wiring stale — [`PLUGIN_AUTHORING.md`](PLUGIN_AUTHORING.md) § Template pack.
