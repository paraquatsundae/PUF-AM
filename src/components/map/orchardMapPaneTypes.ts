...
import type { HighlightDrawMode, HighlightLatLng } from '../../lib/highlightPaintStroke';
...
export type OrchardMapCanvasProps = {
  ...
  onInspectHighlight: (h: MapHighlightDoc) => void;
  ...
  onPaintStrokeEnd: (stroke: HighlightLatLng[], widthM: number) => void;
