...
**Crop packs / Plugins** (Settings → Plugins; Install / Activate / Deactivate / Delete): **how-to** [`Plans/PLUGIN_AUTHORING.md`](Plans/PLUGIN_AUTHORING.md) · contract [`Plans/CROP_PACK_PLUGIN.md`](Plans/CROP_PACK_PLUGIN.md) · catalog `shared/farm/cropPacks.ts` (reads `plugins/<id>/`) · pack code `plugins/<id>/src/`, discovered by `src/packs/registry.ts` at build time — adding a pack edits no core file · zip drop `plugins/` (`npm run plugins:verify|unpack|pack|list`) · Settings UI `src/components/PluginsPanel.tsx` · PR [`.github/PULL_REQUEST_TEMPLATE/crop-pack.md`](.github/PULL_REQUEST_TEMPLATE/crop-pack.md). Freenet is listed under Network & storage (not a crop-pack Install).
