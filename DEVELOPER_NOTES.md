...
| People | That hub’s shelf. Revoke stops new resolves; a device that already joined keeps its FarmSeed copy. Hole 5 **advanced 2026-09-14** (tablet + phone + Linux Bones on Opennet) — still open until two Android devices exchange with no Freenet Android Node. Roles are UI bookkeeping — FarmCode is the crypto boundary. |
