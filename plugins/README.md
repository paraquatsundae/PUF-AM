...
**Layout change planned:** [`Plans/PLUGIN_PACK_LAYOUT.md`](../Plans/PLUGIN_PACK_LAYOUT.md) moves pack code here under `plugins/<id>/src/`, still statically compiled. Hot-load stays out of scope. Plan only — point 3 below describes what ships today.
